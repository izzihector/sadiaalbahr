odoo.define('wk_account_reports.wk_account_report', function (require) {
    'use strict';
    
    var accountReportsWidget = require('account_reports.account_report');
    // var M2MFilters = accountReports.M2MFilters
    ...
    accountReportsWidget.include({ render_searchview_buttons:  function() {
        // this._super.apply(this, arguments);
        var self = this;
        ...
        if (this.report_options.partner) {
            if (!this.M2MFiltersPartner) {
                ...
                if (!_.isEmpty(fields)) {
                    this.M2MFiltersPartner = new M2MFilters(this, fields);
                    this.M2MFiltersPartner.appendTo(this.$searchview_buttons.find('.js_account_partner_m2m'));
                }
            } else {
                this.$searchview_buttons.find('.js_account_partner_m2m').append(this.M2MFiltersPartner.$el);
            }
        }
        console.log(this.report_options)
        console.log(this.M2MFiltersPartner)
        // analytic filter
